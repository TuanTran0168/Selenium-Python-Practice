...
#     print(mht.text)
# print("====================================================================================================")
# for tmh in tenMonHoc:
#     print(tmh.text)
# print("====================================================================================================")
# for stc in soTinChi:
#     print(stc.text)
# print("====================================================================================================")
# for dqt in diemQuaTrinh:
#     print(dqt.text)
# print("====================================================================================================")
# for dt in diemThi:
#     print(dt.text)
...
# for kq in ketQua:
#     try:
#         check = kq.find_element(By.CSS_SELECTOR, "#excel-table > tbody >tr.text-center.ng-star-inserted > td:nth-child(13) > span").get_attribute("class")
#     except:
#         print("BUG NHA")
#     else:
